...
######################################################################
#
# Char::UTF2 - Source code filter to UTF-2 script
#
...
sub Char::UTF2::escape_script {
    ...
    if (/^ use Char::Eutf2(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Eutf2 %s;\n%s", $Char::Eutf2::VERSION, $use_re_eval); # require run-time routines version
...
=head1 SYNOPSIS
  ...
  use Char::UTF2;
  use Char::UTF2 version;         --- require version

...
sub Char::UTF2::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::UTF2::escape_token();
    }
...
# subroutines of package Char::Eutf2
    ...
    elsif (/\G \b Char::UTF2::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::UTF2::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::UTF2::escape'; }
...
# subroutines of package Char::Eutf2
        ...
        elsif ($string =~ /\G \b Char::UTF2::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::UTF2::eval \b                                /oxgc) { $e_string .= 'eval Char::UTF2::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::UTF2::re_t=%s; while($Char::UTF2::re_t =~ %s){%s local $^W=0; local $Char::UTF2::re_r=%s; %s$Char::UTF2::re_t="$`$Char::UTF2::re_r$'"; pos($Char::UTF2::re_t)=length "$`$Char::UTF2::re_r"; } return $Char::UTF2::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::UTF2::re_r=CORE::eval $Char::UTF2::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::UTF2::re_r=%s; %s"%s$Char::UTF2::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::UTF2::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::UTF2::re_r=%s; %s%s="$`$Char::UTF2::re_r$'"; pos(%s)=length "$`$Char::UTF2::re_r"; $Char::UTF2::re_n++} return %s$Char::UTF2::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::UTF2::re_r=%s; %s%s="%s$Char::UTF2::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::UTF2::re_r=%s; %s%s="%s$Char::UTF2::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::UTF2::re_r=CORE::eval $Char::UTF2::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
This module has run-time routines for use Char::UTF2 software automatically, you
do not have to use.

...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Eutf2::binmode(FILEHANDLE, $disciplines);
  Eutf2::binmode(FILEHANDLE);
  Eutf2::binmode($filehandle, $disciplines);
  Eutf2::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Eutf2::open(FILEHANDLE, $mode, $expr);
  $rc = Eutf2::open(FILEHANDLE, $expr);
  $rc = Eutf2::open(FILEHANDLE);
  $rc = Eutf2::open(my $filehandle, $mode, $expr);
  $rc = Eutf2::open(my $filehandle, $expr);
  $rc = Eutf2::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Eutf2::open($fh, ">logfile")     # $fh is autovivified
  ...
  Eutf2::open my $fh, ">logfile" or die ...
  ...
  Eutf2::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Eutf2::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Eutf2::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Eutf2::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Eutf2::open(FH, "<:crlf:encoding(UTF2)", $path) or die "can't open $path: $!";

...
# Char::UTF2::eval $var has Char::UTF2::eval "..."
$var = <<'END';
Char::UTF2::eval " if ('□●' !~ /[◆]/) { return 1 } else { return 0 } "
END
if (Char::UTF2::eval $var) {
...
# Char::UTF2::eval $var has Char::UTF2::eval qq{...}
$var = <<'END';
...
# Char::UTF2::eval $var has Char::UTF2::eval q{...}
$var = <<'END';
...
# Char::UTF2::eval $var has Char::UTF2::eval $var
$var = <<'END';
Char::UTF2::eval $var2
END
...
# Char::UTF2::eval $var has Char::UTF2::eval (omit)
$var = <<'END';
Char::UTF2::eval
END
